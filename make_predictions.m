...
% filter subject 2
for i = 1:v2 
    sub2_1_60filt{i} = filtfilt(Filter1,1.0,Sub2_ecog_ch{i});
    sub2_60_100filt{i} = filtfilt(Filter2,1.0,Sub2_ecog_ch{i});
    sub2_100_200filt{i} = filtfilt(Filter3,1.0,Sub2_ecog_ch{i});
end
